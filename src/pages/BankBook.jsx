...
const BankBook = () => {
    ...
    const handleDeleteTx = async (id) => {
        if (!window.confirm('Are you sure you want to delete this bank transaction? This will reverse its balance impact.')) return;
        try {
            await axios.delete(`/api/banks/transactions/${id}`);
            await fetchBankAccounts();
            await fetchTransactions();
        } catch (err) {
