import{r as c,j as e}from"./vendor-BDQv0xWK.js";import{d as m,l as x,a as y,M as b,T as j,b as v,L as f,u as w}from"./leaflet-CG7_gOri.js";import{d as k,u as S,c as I}from"./index-BE6rsurO.js";import{ai as M,f as C}from"./icons-CeCNtXyO.js";const z=m(function(o,t){const r=new x.Popup(o,t.overlayContainer);return y(r,t)},function(o,t,{position:r},i){c.useEffect(function(){const{instance:s}=o;function d(p){p.popup===s&&(s.update(),i(!0))}function l(p){p.popup===s&&i(!1)}return t.map.on({popupopen:d,popupclose:l}),t.overlayContainer==null?(r!=null&&s.setLatLng(r),s.openOn(t.map)):t.overlayContainer.bindPopup(s),function(){t.map.off({popupopen:d,popupclose:l}),t.overlayContainer?.unbindPopup(),t.map.removeLayer(s)}},[o,t,i,r])});delete f.Icon.Default.prototype._getIconUrl;f.Icon.Default.mergeOptions({iconRetinaUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon-2x.png",iconUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon.png",shadowUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-shadow.png"});const L=n=>{const o=n==="Moving",t=o?"#10b981":"#ef4444";return f.divIcon({className:"custom-car-icon",html:`
            <div style="
                background-color: ${t}; 
                width: 24px; 
                height: 24px; 
